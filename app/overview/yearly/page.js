...
export default function OverviewPage() {
  const [loadFactor, setLoadFactor] = useState(72.0);
  const [volatility, setVolatility] = useState(0.04);
  const [rampRate, setRampRate] = useState(1.2);
  const [currentConsumption, setCurrentConsumption] = useState(54500.5);
  const [currentBars, setCurrentBars] = useState([45, 50, 60, 65, 75, 85, 90, 80, 70, 60, 55, 50]);
    ...
    <DashboardLayout title="URJA">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-grid-gutter">
        ...
        <div className="bg-[#141414] border border-[#262626] rounded-xl p-lg flex flex-col justify-between relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(0,0,0,0.4)]">
          ...
          <div className="relative z-10 flex justify-between items-start mb-xl">
            <h3 className="font-label-caps text-label-caps text-on-surface-variant uppercase tracking-wider">Current Yearly Consumption</h3>
        ...
        <div className="bg-[#141414] border border-[#262626] rounded-xl p-lg flex flex-col justify-between relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(0,0,0,0.4)]">
          <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none border-t border-white/5 rounded-t-xl"></div>
          <div className="relative z-10 flex justify-between items-start mb-xl">
            <h3 className="font-label-caps text-label-caps text-on-surface-variant uppercase tracking-wider">Peak Demand This Year</h3>
        ...
        <div className="bg-[#141414] border border-[#262626] rounded-xl p-lg flex flex-col justify-between relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(0,0,0,0.4)]">
          <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none border-t border-white/5 rounded-t-xl"></div>
          <div className="relative z-10 flex justify-between items-start mb-xl">
            <h3 className="font-label-caps text-label-caps text-on-surface-variant uppercase tracking-wider">Projected 365D Total</h3>
            <span className="material-symbols-outlined text-outline">online_prediction</span>
          </div>
          <div className="relative z-10">
            <div className="flex items-baseline gap-sm">
              <span className="font-display-xl text-display-xl text-on-background">1,125,000</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-grid-gutter mt-xl mb-xl">
        ...
        <div className="bg-[#141414] border border-[#262626] rounded-xl p-lg flex flex-col justify-between relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(0,0,0,0.4)]">
          ...
          <div className="relative z-10">
            <div className="flex items-baseline gap-sm">
              <span className="font-display-xl text-display-xl text-on-background">$21.5</span>
        ...
        <div className="bg-[#141414] border border-[#262626] rounded-xl p-lg flex flex-col justify-between relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(0,0,0,0.4)]">
          ...
          <div className="relative z-10">
            <div className="flex items-baseline gap-sm">
              <span className="font-display-xl text-display-xl text-on-background">July 14:30</span>
        ...
        <div className="bg-[#141414] border border-[#262626] rounded-xl p-lg flex flex-col justify-between relative overflow-hidden group shadow-[0_10px_30px_-15px_rgba(0,0,0,0.4)]">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-xs mt-sm text-on-surface-variant">
              ...
              <span className="font-body-sm text-body-sm">Expected yearly consumption</span>
            </div>
          </div>
        </div>
      </div>
